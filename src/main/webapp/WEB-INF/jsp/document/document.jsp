	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${ctx }/document/deleteDocument?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="documentform" method="post" id="documentform" action="${ctx }/document/findDocumentByParam">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
			...
			<c:forEach items="${requestScope.documentList}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${ctx }/document/showUpdateDocument?id=${document.id}">
							<img filename="修改" src="${ctx }/images/update.gif"/></a>
					  </td>
					  <td align="center"  width="40px;"><a href="#" id="down_${document.id }">
							<img width="20" height="20" filename="下载" src="${ctx }/images/downLoad.png"/></a>
					  </td>
				</tr>
			</c:forEach>
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	   <fkjava:pager 
	  	      ...
	  	      submitUrl="${ctx}/document/selectDocument.action?pageModel.pageIndex={0}&document.filename=${document.filename}"
	  	      style="flickr"
	  	      />
	  </td></tr>
	</table>
