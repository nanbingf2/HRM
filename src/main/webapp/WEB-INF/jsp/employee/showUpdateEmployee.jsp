				 ...
				 <tr><td class="font3 fftd">
					 <table>
						 <tr>
							 ...
							 <td class="font3 fftd">身份证号码：<input type="text" name="card_id" id="card_id" value="${employee.card_id}" size="20"/></td>
						 </tr>
						 <tr>
						 ...
						 <tr>
							 <td class="font3 fftd">手机：<input name="phone" id="phone" value="${employee.phone}" size="20"/></td>
							 <td class="font3 fftd">
								 联系地址：<input name="address" id="address" value="${employee.address}" size="40"/>&nbsp;&nbsp;
							 </td>
						 </tr>
